...
\begin{cventries}
  \cventry
    ...
    {\href{https://github.com/tacticaltofu/mangastack}{source code \faExternalLink}} % Empty location
  ...
  \cventry
    {\fontsize{10pt}{1em}\bodyfont\upshape\color{text}{News aggregation and discussion website very similar to Reddit}} % Empty position
    {Reddit Clone} % Project
    {\href{https://github.com/tacticaltofu/reddit-clone}{source code \faExternalLink}} % Empty location
