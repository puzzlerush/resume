...
\begin{cventries}
  \cventry
    ...
    {Sept 2021 - Dec 2021} % Date(s)
    {
      ...
      \item {Created data syncs using \textbf{Hightouch}, \textbf{dbt}, and \textbf{Snowflake} to segment users based on transaction history}
      \item {Integrated third-party APIs into existing user flows to ensure application security and fraud prevention}
